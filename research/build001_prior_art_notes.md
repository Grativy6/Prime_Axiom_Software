# Build 001 architecture-specific prior-art notes

## Scope and evidence status

This note investigates the proposed Build 001 value shape
...
where `S` is a finite selected-prime bank and `c` is an exact residual cofactor. It is a research input, not a novelty, performance, or hardware claim. Sources were checked on 2026-08-24. Primary papers, official project documentation, and pinned upstream source are preferred. Build 000's broader survey remains controlling for the already-covered neighboring fields.
