...
Before changing claims or experiments, read `BUILD_003_REPORT.md`, `research/build003_experiment_plan.md`, `docs/PRIME_RECEIPT_CALCULATOR.md`, and `docs/OBSERVATIONS.md`. For inherited hardware claims, also read `BUILD_002_REPORT.md`, `research/build002_experiment_plan.md`, `docs/HARDWARE_EXPERIMENTS.md`, `docs/HARDWARE_COST_MODEL.md`, `docs/HARDWARE_PRIOR_ART.md`, and `docs/HARDWARE_MATHEMATICS.md`. Read the Build 000/001 reports for inherited scope. Preserve negative results, failed receipts, frozen hashes, and exact claim ceilings.
